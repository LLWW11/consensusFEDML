...
from HFLSnF_KG_v5.run_final_dynamic_fedadam import (
    CONTRACT_FILE_NAME,
    FinalDynamicRunError,
    create_batch_manifest,
    run_batch,
)
from HFLSnF_KG_v5.tasks.kge.final_dynamic_fedadam import (
    ARMS,
    SCENARIOS,
    SEEDS,
    build_provider,
...
class FinalDynamicFedAdamTest(unittest.TestCase):
    ...
    def test_batch_all_success_preserves_order_and_contracts(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "HFLSnF_KG_v5.run_final_dynamic_fedadam._run_config",
                side_effect=fake_run,
            ), patch(
                "HFLSnF_KG_v5.run_final_dynamic_fedadam.validate_result",
