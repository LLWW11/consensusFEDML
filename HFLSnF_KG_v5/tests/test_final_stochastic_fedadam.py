...
from HFLSnF_KG_v5.run_final_stochastic_fedadam import (
    _load_manifest,
    create_batch_manifest,
    run_batch,
)
from HFLSnF_KG_v5.tasks.kge.final_stochastic_fedadam import (
    ARM_CONTRACTS,
    ROUND_COUNT,
    SCENARIOS,
    build_provider,
...
class FinalStochasticTopologyTest(unittest.TestCase):
    ...
    def test_nine_configs_pass_without_constructing_mat_provider(self) -> None:
        ...
        with mock.patch(
            "HFLSnF_KG_v5.core.topology.MatlabTopologyProvider.__init__",
...
class FinalStochasticBatchTest(unittest.TestCase):
    ...
    def test_resume_skips_passed_entry_and_finishes_remaining_entries(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            with mock.patch(
                "HFLSnF_KG_v5.run_final_stochastic_fedadam._run_config",
                return_value=fake_result,
            ) as run_mock, mock.patch(
                "HFLSnF_KG_v5.run_final_stochastic_fedadam.validate_result",
