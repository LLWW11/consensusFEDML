...
from HFLSnF_KG_v5.run_fedadam_stage2 import (
    PLANNED_RUN_COUNT,
    Stage2RunError,
    create_batch_manifest,
    run_phase,
)
from HFLSnF_KG_v5.tasks.kge.fedadam_stage2 import (
...
class FedAdamStage2Test(unittest.TestCase):
    ...
    def test_screen_failure_stops_and_resume_skips_passed(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "HFLSnF_KG_v5.run_fedadam_stage2._run_config",
                side_effect=fail_second,
            ), patch(
                "HFLSnF_KG_v5.run_fedadam_stage2.validate_result",
                side_effect=self._fake_contract,
            ), patch(
                "HFLSnF_KG_v5.run_fedadam_stage2.summarize_result",
                side_effect=self._fake_summary,
            ), patch(
                "HFLSnF_KG_v5.run_fedadam_stage2.write_phase_artifacts",
                return_value={},
            ):
    ...
    def test_report_writer_creates_all_required_plots(self) -> None:
        ...
        from HFLSnF_KG_v5.reports.gen_fedadam_stage2_report import (
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "HFLSnF_KG_v5.reports.gen_fedadam_stage2_report._full_summary",
