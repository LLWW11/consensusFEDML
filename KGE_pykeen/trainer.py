...
from .objectives import WeightedNSSALossAdapter
...
class CentralizedTransETrainer:
    ...
    def __init__(
        ...
        self.weighted_nssa_loss = WeightedNSSALossAdapter(
            gamma=self.gamma,
